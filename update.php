...
<body id="home">
    ...
    <section id="hero-text" class="d-flex align-items-center" style="height: 100vh; padding: 40px;">
        ...
        $sql = "UPDATE book SET title='$db_Title', author='$db_Author', book_description='$db_decp', category='$db_cat' WHERE id=$db_id";
        ...
        ?>
            <div class="jumbotron" style="background-color:green ;">
                ...
                <p class="lead">Record has been Updated!!</p>

                <p class="lead">
                    <a class="btn btn-primary btn-lg " style="background-color: white; font-weight:bold;" href="view.php" role="button">Click here to View</a>
                </p>
            </div>
        <?php  } else {    ?>
            ...
            <div class="jumbotron " style="background-color:red ;">
                ...
                <p class="lead">Record has not been Updated Successfully!!</p>
