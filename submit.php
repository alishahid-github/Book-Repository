...
<body id="home">
    ...
    <section id="hero-text" class="d-flex align-items-center" style="height: 100vh; padding: 40px;">
        <?php
            ...
            $sql = "INSERT INTO book (title, author, book_description ,category) VALUES ('$db_Title', '$db_Author', '$db_decp','$db_cat'  )";
            ...
            if ($conn->query($sql) === TRUE) 
            {
                ...
                <p class="lead">
                    <a class="btn btn-primary btn-lg " style="background-color: white; font-weight:bold;"
                    href="view.php" role="button">View</a>
                </p>
                </div>           
                <?php
                ...
                <p class="lead">
                    <a class="btn btn-primary btn-lg" style="background-color: white; font-weight:bold;" 
                    href="index.html" role="button">Go Home</a>
                </p>
                </div>
                <?php
